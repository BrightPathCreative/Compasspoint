...
import { getServiceHeroImageAlt, getServiceImagePath, SERVICES } from "@/lib/services";
    ...
    <article className="home-service-tile group relative flex min-h-[340px] flex-col overflow-hidden rounded-2xl border border-white/10 shadow-[0_28px_70px_-28px_rgba(0,0,0,0.65)] sm:min-h-[380px] lg:aspect-[3/4] lg:min-h-0">
      ...
      <div className="relative mt-auto flex flex-col p-5 pt-16 sm:p-6 sm:pt-20">
        <p className="font-[family-name:var(--font-montserrat)] text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--metallic-gold)]">
          <span className="inline-block border border-[var(--metallic-gold)]/80 bg-black/35 px-2.5 py-1 backdrop-blur-[2px]">
        ...
        <details className="mt-4 border-t border-white/15 pt-4 text-left [&[open]>summary_svg]:rotate-180">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-3 rounded-md border-2 border-[var(--metallic-gold)] bg-black/50 px-3.5 py-3 font-[family-name:var(--font-montserrat)] text-xs font-bold uppercase tracking-[0.14em] text-[var(--metallic-gold)] shadow-[0_0_0_1px_rgba(212,175,55,0.12)] transition-colors hover:bg-black/65 hover:text-[color-mix(in_srgb,var(--metallic-gold)_88%,#fff)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--metallic-gold)] [&::-webkit-details-marker]:hidden">
            <span>Read more</span>
            <ChevronDown
          ...
          <div className="mt-4 space-y-4 border-t border-[var(--metallic-gold)]/25 pt-4">
